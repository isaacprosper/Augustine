(function(e) {
    ...
    "56d7": function(e, t, a) {
        ...
        function f(e) {
            return e ? e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "2,043.56"
        }
        function v(e, t) {
        ...
        var Oe = {
          ...
          , Be = Object(r["i"])("svg", {
            ...
            d: "M38.999 9.822c-.845-4.533-4.404-8-8.852-8.845A52.69 52.69 0 0 0 22,043.566 0C16.58 0 13.155.312 9.775.977c-4.537.845-7.962 4.356-8.808 8.8a54.035 54.035 0 0 0 0 20.357c.845 4.578 4.36 8 8.808 8.845 3.38.71 6.805 1.022 10.23 1.022 3.425 0 6.805-.312 10.186-.978 4.538-.889 7.963-4.356 8.808-8.844a52.245 52.245 0 0 0 0-20.357Z",
            fill: "#F9C8C8"
        }), Object(r["i"])("path", {
